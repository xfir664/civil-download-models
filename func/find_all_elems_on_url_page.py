...
from func.find_elems.find_description_div import find_description_div
...
def find_all_elems_on_url_page(driver, elems):
    ...
    description_div = find_description_div(driver, elems["description_container"])
    ...
    return title, description_div, download_btn, img, details_div, details_type, details_base_model